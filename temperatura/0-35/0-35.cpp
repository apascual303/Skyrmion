...
double kappa=2.00;   //Anisotropy parameter (kappa)
double alpha=0.50; //Gilbert damping constant (alpha)
...
void TimeEvolution(){
	...
	//Update m and normalize
		...
		if((t%tout)==0){
			...
			sprintf(buffer,"C:/Users/anapascual/Desktop/s_skyrmions/temperatura/0-35/temperatura_%d.txt",k);
			k=k+1;
