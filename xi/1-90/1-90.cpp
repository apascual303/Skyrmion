...
double xi=1.90;//1.68;//1.290238; //DM parameter (xi)
double kappa=2.0;   //Anisotropy parameter (kappa)
...
mz[i][j]+=(h/6.0)*(k1z[i][j]+2.0*k2z[i][j]+2.0*k3z[i][j]+k4z[i][j]);
	...
	sprintf(buffer,"C:/Users/anapascual/Desktop/s_skyrmions/xi/1-90/xi_%d.txt",k);
	k=k+1;
